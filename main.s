...
facil: .string "1 - facil"
medio: .string "2 - medio"
dificil: .string "3 - dificil"
fimMenu: .string "menu"
fimRestart: .string "restart"
...
Blackout0Loop:
	beq t0,t1,Blackout0End  #se escever a quantidade de words suficientes, finaliza o loopp
...
Blackout0End:
	li t0,0 
	li t1,19200
	lw t2,frame_one	#endereço base da frame
	li t3,0
Blackout1Loop:
	beq t0,t1,Blackout1End  #se escever a quantidade de words suficientes, finaliza o loopp
	slli t4,t0,2		#t4 = 4* indice_da_word
	add t4,t4,t2		#t4 = endereço_base_da_frame + 4* indice_da_word
	sw t3, (t4)		
	addi t0,t0,1
...
menuLoop:				#s1 armazenará status da seleção
	...
	li t0, '1'
	li t1, '2'
	beq a0,t0,easySelected
	beq a0,t1,mediumSelected
				# De outra forma, hard foi selecionado
	li a6,2
	j startGame
